...
<html>
<head>
<link href="/market/css/blog.css" rel="stylesheet">
...
<body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item" href="/market/notice/">고객센터</a>
          <a class="blog-nav-item" id="notice" href="/market/notice/noticelist/">공지사항</a>
          <a class="blog-nav-item" id="faq" href="/market/notice/qna/">FAQ</a>
          <a class="blog-nav-item" id="event" href="/market/notice/event/">event</a>
        </nav>
      </div>
    </div>
